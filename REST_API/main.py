...
def get_cafe_at_location():
    # the loc word will pull from the query in the url
    # e.g. http://127.0.0.1:5000/search?loc=Peckham - for this the query_location will be Peckham.
    query_location = request.args.get("loc")
    # location is set to the query_location once it is pulled from the URL
